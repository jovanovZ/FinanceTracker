...
const Login = ({ nav }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        // Uspešna prijava - preusmeri na dashboard ali profile
        navigate('/profile');
      } else {
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            <div className="checkbox-row">
              ...
              <button 
                type="button" 
                className="link-btn" 
                onClick={() => nav ? nav('forgot-password') : navigate('/forgot-password')}
              >
                Forgot password?
              </button>
            </div>
            ...
            <p className="auth-footer">
              New here?{' '}
              <a onClick={() => nav ? nav('signup') : navigate('/signup')}>Create an account</a>
            </p>
          </form>
        </div>
      </div>
